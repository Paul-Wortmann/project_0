...
bool config_class::file_load(void)
{
    ...
    {
        game.core.log.write("Fail -> Configuration file name invalid - "+config_class::file_name);
        return(false);
    }
    else
    {
        ...
        {
            game.core.log.write("Fail -> Configuration file unable to open - "+config_class::file_name);
            config_class::file_save();
            return(false);
        }
    }
    config_class::font_scale_x         = (float)config_class::display_resolution_x/(float)config_class::font_base_resolution_x;
    ...
    config_class::mouse_resolution_x   = config_class::display_resolution_x;
    config_class::mouse_resolution_y   = config_class::display_resolution_y;
    game.core.log.write("Configuration file loaded - "+config_class::file_name);
    return(true);
};

bool         config_class::file_save(void)
{
    config_class::file_clear();
    if (config_class::file_name.length() < 5)
    {
        game.core.log.write("Fail -> Configuration file name invalid - "+config_class::file_name);
        return(false);
...
void config_class::log_system_information(void)
{
    ...
    game.core.log.write("Detected - " + game.core.misc.itos(config_class::system_info.CPU_count) + " logical CPU cores");
    game.core.log.write("Detected - " + game.core.misc.itos(config_class::system_info.CPU_cache_line_size) + " CPU cache line size");
    game.core.log.write("Detected - " + game.core.misc.itos(config_class::system_info.system_RAM) + "MB system RAM");
...
void config_class::log_config_information(void)
{
    game.core.log.write("# --------- Configuration Information ---------- #");
    if (config_class::display_fullscreen) game.core.log.write("Display_Fullscreen     - True"); else  game.core.log.write("Display_Fullscreen     - False");
    game.core.log.write("Display_Resolution_X   - "+game.core.misc.itos(config_class::display_resolution_x));
    game.core.log.write("Display_Resolution_Y   - "+game.core.misc.itos(config_class::display_resolution_y));
    game.core.log.write("Display_BPP            - "+game.core.misc.itos(config_class::display_bpp));
    game.core.log.write("Audio_Rate             - "+game.core.misc.itos(config_class::audio_rate));
    game.core.log.write("Audio_Channels         - "+game.core.misc.itos(config_class::audio_channels));
    game.core.log.write("Audio_Buffers          - "+game.core.misc.itos(config_class::audio_buffers));
    game.core.log.write("Audio_Volume_Music     - "+game.core.misc.itos(config_class::audio_volume_music));
    game.core.log.write("Audio_Volume_Sound     - "+game.core.misc.itos(config_class::audio_volume_sound));
    game.core.log.write("# ---------------------------------------------- #");
}
