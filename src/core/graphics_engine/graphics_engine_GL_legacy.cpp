...
bool GL_legacy_init(void)
{
    ...
    else
    {
        ...
        */
        ...
        SDL_GL_SetAttribute(SDL_GL_CONTEXT_MAJOR_VERSION, RENDERER_GL1_CONTEXT_MAJOR);
        SDL_GL_SetAttribute(SDL_GL_CONTEXT_MINOR_VERSION, RENDERER_GL1_CONTEXT_MINOR);
        ...
        else
        {
            ...
            std::string string_data = game.core.misc.cuctos(glGetString(GL_EXTENSIONS)) +" ";
            ...
            for (int j = 0; j < game.core.graphics.gl_extention_count; j++)
            {
                ...
                while (temp_char != ' ')
                {
                    temp_char = string_data[temp_position];
            ...
            if ((last_w != game.core.graphics.display_mode[i].w) || (last_h != game.core.graphics.display_mode[i].h))
            {
                ...
                if (list_position < game.core.graphics.menu_mode_length)
                {
                    ...
                    if (game.core.debug)
                    {
                        ...
                        string_data += " - y - ";
                        string_data += game.core.misc.itos(game.core.graphics.display_mode[i].h);
