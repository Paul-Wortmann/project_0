...
#ifndef GRAPHICS_ENGINE_GLES_H
#define GRAPHICS_ENGINE_GLES_H

bool        GLES_init(void);
bool        GLES_deinit(void);
bool        GLES_render(void);
bool        GLES_build_mode_list(void);
std::string GLES_get_display_mode(int mode_number);

#endif // GRAPHICS_ENGINE_GLES_H
